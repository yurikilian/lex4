...
import { PAGE_MARGIN_X_PX, PAGE_MARGIN_Y_PX, PX_PER_MM } from '../constants';

const MARGIN_X_MM = Math.round((PAGE_MARGIN_X_PX / PX_PER_MM) * 10) / 10;
const MARGIN_Y_MM = Math.round((PAGE_MARGIN_Y_PX / PX_PER_MM) * 10) / 10;
